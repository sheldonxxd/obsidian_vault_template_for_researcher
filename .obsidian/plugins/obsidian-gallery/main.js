...
https://github.com/Darakah/obsidian-gallery#release-notes
`;
const GALLERY_RESOURCES_MISSING = `
 ...
 */
const initializeInfo = (imgPath, imgName) => {
 ...
 */
const getImgInfo = async (imgPath, vault, metadata, plugin, create) => {
    var _a;
    let infoFile = null;
    ...
    if (infoFolder instanceof obsidian.TFolder) {
        (_a = infoFolder.children) === null || _a === void 0 ? void 0 : _a.forEach(info => {
            var _a, _b;
            if (info instanceof obsidian.TFile) {
                infoFileList.push(info.basename);
                (_b = (_a = metadata.getFileCache(info)) === null || _a === void 0 ? void 0 : _a.links) === null || _b === void 0 ? void 0 : _b.forEach(link => {
        ...
        if (!infoFile && create) {
            ...
            infoFile = vault.getAbstractFileByPath(`${plugin.settings.imgDataFolder}/${fileName}.md`);
        }
        return infoFile;
    }
 ...
 */
const getImageResources = (path, name, vaultFiles, handler) => {
    let imgList = {};
    let reg;
    try {
...
class GallerySettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        let infoPathSetting = new obsidian.Setting(containerEl)
            .setName('Gallery Info Folder')
            .setDesc("")
            .addButton(text => text
            .setButtonText('Save')
            .onClick(() => {
            if (resourcesPathInput === '/' || !(this.plugin.app.vault.getAbstractFileByPath(resourcesPathInput) instanceof obsidian.TFolder)) {
                return;
            }
...
/* node_modules/svelte-image-gallery/Gallery.svelte generated by Svelte v3.32.3 */

function add_css() {
	var style = element("style");
	style.id = "svelte-456lsy-style";
	style.textContent = "#slotHolder.svelte-456lsy.svelte-456lsy{display:none}#gallery.svelte-456lsy.svelte-456lsy{width:100%;display:grid;gap:var(--gap)}#gallery.svelte-456lsy .column.svelte-456lsy{display:flex;flex-direction:column}#gallery.svelte-456lsy .column .svelte-456lsy{width:100%;margin-top:var(--gap)}#gallery.svelte-456lsy .column .svelte-456lsy:nth-child(1){margin-top:0}";
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			attr(div, "id", "gallery");
			attr(div, "style", /*galleryStyle*/ ctx[3]);
			attr(div, "class", "svelte-456lsy");
		...
		p(ctx, dirty) {
			if (dirty & /*columns, videoRegex*/ 20) {
...
function create_else_block(ctx) {
	...
	return {
		c() {
			img = element("img");
			attr(img, "class", "gallery-grid-img svelte-456lsy");
			if (img.src !== (img_src_value = /*url*/ ctx[16])) attr(img, "src", img_src_value);
			attr(img, "alt", "");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*columns*/ 4 && img.src !== (img_src_value = /*url*/ ctx[16])) {
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			video = element("video");
			if (video.src !== (video_src_value = /*url*/ ctx[16])) attr(video, "src", video_src_value);
			video.controls = true;
			attr(video, "class", "svelte-456lsy");
		},
		m(target, anchor) {
			insert(target, video, anchor);
		},
		p(ctx, dirty) {
			if (dirty & /*columns*/ 4 && video.src !== (video_src_value = /*url*/ ctx[16])) {
...
// (45:16) {#each column as url}
function create_each_block_1(ctx) {
	let show_if;
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (show_if == null || dirty & /*columns*/ 4) show_if = !!/*url*/ ctx[16].match(/*videoRegex*/ ctx[4]);
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			t = space();
			attr(div, "class", "column svelte-456lsy");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_fragment(ctx) {
	...
	let if_block = /*columns*/ ctx[2] && create_if_block(ctx);
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(div, "DOMNodeInserted", /*Draw*/ ctx[5]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
...
function instance($$self, $$props, $$invalidate) {
	...
	let galleryWidth = 0;
	let columnCount = 0;
	let videoRegex = new RegExp(".*\\.mp4\\?\\d*$");
	onMount(Draw);
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*columnCount, gap*/ 320) {
...
class Gallery extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-456lsy-style")) add_css();
		init(this, options, instance, create_fragment, safe_not_equal, { gap: 6, maxColumnWidth: 7 });
	}
}

/* src/svelte/ImageGrid.svelte generated by Svelte v3.32.3 */
...
function create_each_block$1(ctx) {
	...
	return {
		c() {
			img = element("img");
			if (img.src !== (img_src_value = /*img*/ ctx[2])) attr(img, "src", img_src_value);
			attr(img, "class", "gallery-grid-img");
			attr(img, "alt", "");
			attr(img, "width", /*maxColumnWidth*/ ctx[1]);
		},
		m(target, anchor) {
			insert(target, img, anchor);
		},
		p(ctx, dirty) {
			if (dirty & /*imageList*/ 1 && img.src !== (img_src_value = /*img*/ ctx[2])) {
				attr(img, "src", img_src_value);
			}

			if (dirty & /*maxColumnWidth*/ 2) {
				attr(img, "width", /*maxColumnWidth*/ ctx[1]);
			}
		},
		d(detaching) {
...
// (7:0) <Gallery gap="5" {maxColumnWidth}>
function create_default_slot(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*imageList, maxColumnWidth*/ 3) {
...
function create_fragment$1(ctx) {
	...
	gallery = new Gallery({
			props: {
				gap: "5",
				maxColumnWidth: /*maxColumnWidth*/ ctx[1],
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*maxColumnWidth*/ 2) gallery_changes.maxColumnWidth = /*maxColumnWidth*/ ctx[1];

			if (dirty & /*$$scope, imageList, maxColumnWidth*/ 35) {
...
function instance$1($$self, $$props, $$invalidate) {
	let { imageList } = $$props;
	let { maxColumnWidth = 400 } = $$props;

	$$self.$$set = $$props => {
		if ("imageList" in $$props) $$invalidate(0, imageList = $$props.imageList);
		if ("maxColumnWidth" in $$props) $$invalidate(1, maxColumnWidth = $$props.maxColumnWidth);
	};

	return [imageList, maxColumnWidth];
}

class ImageGrid extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { imageList: 0, maxColumnWidth: 1 });
	}
}
...
class GalleryView extends obsidian.ItemView {
    constructor(leaf, plugin) {
        ...
        obsidian.setIcon(searchPanel, 'fa-search', 17);
    ...
    updateDisplay(path, name) {
        ...
        this.imgResources = getImageResources(path, name, this.app.vault.getFiles(), this.app.vault.adapter);
...
class GalleryInfoView extends obsidian.ItemView {
    constructor(leaf, plugin) {
        ...
        this.requestSave = obsidian.debounce(this.saveFile, 2500, false);
        this.plugin = plugin;
        // Get View Container Element
    ...
    onload() {
        ...
        if ((gallery === null || gallery === void 0 ? void 0 : gallery.view) instanceof GalleryView) {
            ...
            displayEl.onclick = async (evt) => {
                ...
                if (evt.target instanceof HTMLImageElement) {
                    ...
                    updateFocus(this.galleryView.focusImage, this.galleryView.focusVideo, this.galleryView.imgList[this.galleryView.imgFocusIndex], false);
                ...
                if (evt.target instanceof HTMLVideoElement) {
                    ...
                    updateFocus(this.galleryView.focusImage, this.galleryView.focusVideo, this.galleryView.imgList[this.galleryView.imgFocusIndex], true);
                    await this.updateInfoDisplay();
                }
            };
    ...
    async updateInfoDisplay() {
        this.infoFile = await getImgInfo(this.galleryView.imgResources[this.imgPath], this.app.vault, this.app.metadataCache, this.plugin, true);
    ...
    async render() {
        ...
        obsidian.MarkdownRenderer.renderMarkdown(this.editor.getValue(), this.contentEl, '/', this);
    }
    async saveFile() {
        // Save file content
        if (this.infoFile) {
...
/* node_modules/svelte-grid/src/MoveResize/index.svelte generated by Svelte v3.32.3 */
...
/* node_modules/svelte-grid/src/index.svelte generated by Svelte v3.32.3 */
...
function create_default_slot$1(ctx) {
	let t;
	let current;
	let if_block = /*item*/ ctx[27][/*getComputedCols*/ ctx[4]] && create_if_block_1$2(ctx);
...
function create_fragment$3(ctx) {
	let div;
	let current;
	let if_block = (/*xPerPx*/ ctx[6] || !/*fastStart*/ ctx[1]) && create_if_block$2(ctx);
...
class Src extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-p0xk9p-style")) add_css$2();
...
/* src/svelte/Gallery.svelte generated by Svelte v3.32.3 */
...
class Gallery$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { imgList: 3, width: 4, fillFree: 0 });
	}
}

/* src/svelte/GalleryInfo.svelte generated by Svelte v3.32.3 */

function add_css$3() {
	var style = element("style");
	style.id = "svelte-gec6de-style";
	style.textContent = ".gallery-info-container.svelte-gec6de.svelte-gec6de{border:1px solid var(--background-modifier-border);font-size:14px;color:var(--text-muted);padding:6px 14px;border-radius:4px;background-color:var(--background-primary-alt);position:inherit;margin-bottom:30px}.gallery-info-container.svelte-gec6de .gallery-info-section.svelte-gec6de{margin:6px 0;display:flex}.gallery-info-section-label.svelte-gec6de.svelte-gec6de{margin-right:20px}.gallery-info-section-value.svelte-gec6de.svelte-gec6de{color:var(--text-a);overflow-wrap:anywhere}.gallery-info-color.svelte-gec6de.svelte-gec6de{width:30px;height:10px;margin-top:6px;background-color:aqua;float:left}.gallery-info-container.svelte-gec6de .gallery-info-section-tags.svelte-gec6de{display:inline-flex;flex-wrap:wrap;align-items:center}.gallery-info-section-tags.svelte-gec6de>.tag.svelte-gec6de{background-color:#333333;border:none;color:black;--text-a:var(--bright-orange);--text-a-hover:var(--bright-blue);font-size:11px;padding:1px 8px;text-align:center;text-decoration:none;display:inline-block;margin:0px 0px;cursor:pointer;border-radius:14px}.img-info-link.svelte-gec6de.svelte-gec6de{color:var(--text-muted)}";
	append(document.head, style);
}
...
// (28:4) {#if infoList.length != 0 || !infoList.contains("name")}
function create_if_block_13(ctx) {
	...
	return {
		c() {
			...
			div0 = element("div");
			t2 = text(/*name*/ ctx[0]);
			attr(span, "class", "gallery-info-section-label svelte-gec6de");
			attr(div0, "class", "gallery-info-section-value svelte-gec6de");
			attr(div1, "class", "gallery-info-section svelte-gec6de");
		},
		m(target, anchor) {
...
// (34:4) {#if infoList.length != 0 || !infoList.contains("path")}
function create_if_block_12(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*path*/ 2) set_data(t2, /*path*/ ctx[1]);
		},
		d(detaching) {
			if (detaching) detach(div1);
		}
...
// (42:4) {#if infoList.length != 0 || !infoList.contains("extension")}
function create_if_block_11(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*extension*/ 4) set_data(t2, /*extension*/ ctx[2]);
		},
		d(detaching) {
			if (detaching) detach(div1);
		}
...
// (48:4) {#if infoList.length != 0 || !infoList.contains("size")}
function create_if_block_10(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*size*/ 8) set_data(t2, /*size*/ ctx[3]);
		},
		d(detaching) {
			if (detaching) detach(div1);
		}
...
// (54:4) {#if infoList.length != 0 || !infoList.contains("dimension")}
function create_if_block_8(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*isVideo*/ ctx[8]) return create_if_block_9;
...
function create_else_block$1(ctx) {
	let t0_value = /*dimensions*/ ctx[4]?.naturalWidth + "";
	let t0;
	let t1;
	let t2_value = /*dimensions*/ ctx[4]?.naturalHeight + "";
	let t2;
	let t3;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*dimensions*/ 16 && t0_value !== (t0_value = /*dimensions*/ ctx[4]?.naturalWidth + "")) set_data(t0, t0_value);
			if (dirty & /*dimensions*/ 16 && t2_value !== (t2_value = /*dimensions*/ ctx[4]?.naturalHeight + "")) set_data(t2, t2_value);
		},
		d(detaching) {
...
function create_if_block_9(ctx) {
	...
	return {
		c() {
			t0 = text(/*width*/ ctx[12]);
			t1 = text(" x ");
			t2 = text(/*height*/ ctx[13]);
			t3 = text(" px");
		},
		m(target, anchor) {
			insert(target, t0, anchor);
		...
		p(ctx, dirty) {
			if (dirty & /*width*/ 4096) set_data(t0, /*width*/ ctx[12]);
			if (dirty & /*height*/ 8192) set_data(t2, /*height*/ ctx[13]);
		},
		d(detaching) {
			if (detaching) detach(t0);
			if (detaching) detach(t1);
...
// (66:4) {#if infoList.length != 0 || !infoList.contains("date")}
function create_if_block_7(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*date*/ 32) set_data(t2, /*date*/ ctx[5]);
		},
		d(detaching) {
			if (detaching) detach(div1);
		}
...
// (72:4) {#if infoList.length != 0 || !infoList.contains("tags")}
function create_if_block_5(ctx) {
	let div1;
	let span;
	let t1;
	let div0;
	let if_block = /*tagList*/ ctx[6] && create_if_block_6(ctx);
	...
	return {
		c() {
			...
			if (if_block) if_block.c();
			attr(span, "class", "gallery-info-section-label svelte-gec6de");
			attr(div0, "class", "gallery-info-section-tags svelte-gec6de");
			attr(div1, "class", "gallery-info-section mod-tags svelte-gec6de");
		},
		m(target, anchor) {
			insert(target, div1, anchor);
			append(div1, span);
...
function create_if_block_6(ctx) {
	let each_1_anchor;
	let each_value_3 = /*tagList*/ ctx[6];
	let each_blocks = [];
...
// (77:20) {#each tagList as tag}
function create_each_block_3(ctx) {
	let a;
	let t_value = /*tag*/ ctx[23] + "";
	let t;
	let a_href_value;
	...
	return {
		c() {
			a = element("a");
			t = text(t_value);
			attr(a, "class", "tag svelte-gec6de");
			attr(a, "target", "_blank");
			attr(a, "rel", "noopener");
			attr(a, "href", a_href_value = /*tag*/ ctx[23]);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*tagList*/ 64 && t_value !== (t_value = /*tag*/ ctx[23] + "")) set_data(t, t_value);

			if (dirty & /*tagList*/ 64 && a_href_value !== (a_href_value = /*tag*/ ctx[23])) {
...
// (86:4) {#if infoList.length != 0 || !infoList.contains("backlinks")}
function create_if_block_4(ctx) {
	let div1;
	let span;
	let t1;
	let div0;
	let each_value_2 = /*imgLinks*/ ctx[9];
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*imgLinks*/ 512) {
				each_value_2 = /*imgLinks*/ ctx[9];
				let i;
...
// (90:16) {#each imgLinks as link}
function create_each_block_2(ctx) {
	let li;
	let a;
	let t0_value = /*link*/ ctx[20].name + "";
	let t0;
	let a_href_value;
	let t1;
	...
	return {
		c() {
			...
			attr(a, "href", a_href_value = /*link*/ ctx[20].path);
			attr(li, "class", "img-info-link svelte-gec6de");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*imgLinks*/ 512 && t0_value !== (t0_value = /*link*/ ctx[20].name + "")) set_data(t0, t0_value);

			if (dirty & /*imgLinks*/ 512 && a_href_value !== (a_href_value = /*link*/ ctx[20].path)) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
function create_if_block_2(ctx) {
	let each_1_anchor;
	let each_value_1 = Object.keys(/*frontmatter*/ ctx[10]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*frontmatter, Object, infoList*/ 3072) {
				each_value_1 = Object.keys(/*frontmatter*/ ctx[10]);
				let i;
...
// (101:12) {#if yaml != "position" && (infoList.length != 0 || !infoList.contains(yaml))}
function create_if_block_3(ctx) {
	let div1;
	let span;
	let t0_value = /*yaml*/ ctx[17] + "";
	let t0;
	let t1;
	let div0;
	let t2_value = /*frontmatter*/ ctx[10][/*yaml*/ ctx[17]] + "";
	let t2;
	let t3;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*frontmatter*/ 1024 && t0_value !== (t0_value = /*yaml*/ ctx[17] + "")) set_data(t0, t0_value);
			if (dirty & /*frontmatter*/ 1024 && t2_value !== (t2_value = /*frontmatter*/ ctx[10][/*yaml*/ ctx[17]] + "")) set_data(t2, t2_value);
		},
		d(detaching) {
			if (detaching) detach(div1);
		}
...
// (100:8) {#each Object.keys(frontmatter) as yaml}
function create_each_block_1$1(ctx) {
	let show_if = /*yaml*/ ctx[17] != "position" && (/*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains(/*yaml*/ ctx[17]));
	let if_block_anchor;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*frontmatter, infoList*/ 3072) show_if = /*yaml*/ ctx[17] != "position" && (/*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains(/*yaml*/ ctx[17]));
...
// (112:4) {#if infoList.length != 0 || !infoList.contains("palette")}
function create_if_block$3(ctx) {
	...
	let div1;
	let div0;
	let if_block = /*colorList*/ ctx[7] && create_if_block_1$3(ctx);
	...
	return {
		c() {
			...
			if (if_block) if_block.c();
			attr(span, "class", "gallery-info-section-label svelte-gec6de");
			attr(div0, "width", "max-content");
			attr(div1, "class", "gallery-info-section-value svelte-gec6de");
			attr(div2, "class", "gallery-info-section mod-tags svelte-gec6de");
		},
		m(target, anchor) {
...
function create_if_block_1$3(ctx) {
	let each_1_anchor;
	let each_value = /*colorList*/ ctx[7];
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*colorList*/ 128) {
				each_value = /*colorList*/ ctx[7];
				let i;
...
// (118:24) {#each colorList as color}
function create_each_block$3(ctx) {
	...
	return {
		c() {
			div = element("div");
			attr(div, "class", "gallery-info-color svelte-gec6de");
			attr(div, "aria-label", div_aria_label_value = /*color*/ ctx[14].hex);
			set_style(div, "background-color", /*color*/ ctx[14].hex);
		},
		m(target, anchor) {
			insert(target, div, anchor);
		},
		p(ctx, dirty) {
			if (dirty & /*colorList*/ 128 && div_aria_label_value !== (div_aria_label_value = /*color*/ ctx[14].hex)) {
...
function create_fragment$5(ctx) {
	let div;
	let show_if_8 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("name");
	let t0;
	let show_if_7 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("path");
	let t1;
	let show_if_6 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("extension");
	let t2;
	let show_if_5 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("size");
	let t3;
	let show_if_4 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("dimension");
	let t4;
	let show_if_3 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("date");
	let t5;
	let show_if_2 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("tags");
	let t6;
	let show_if_1 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("backlinks");
	let t7;
	let t8;
	let show_if = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("palette");
	...
	let if_block4 = show_if_4 && create_if_block_8(ctx);
	let if_block5 = show_if_3 && create_if_block_7(ctx);
	let if_block6 = show_if_2 && create_if_block_5(ctx);
	let if_block7 = show_if_1 && create_if_block_4(ctx);
	let if_block8 = /*frontmatter*/ ctx[10] && create_if_block_2(ctx);
	let if_block9 = show_if && create_if_block$3(ctx);
	...
	return {
		c() {
			...
			attr(div, "class", "gallery-info-container svelte-gec6de");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			if (if_block0) if_block0.m(div, null);
		...
		p(ctx, [dirty]) {
			if (dirty & /*infoList*/ 2048) show_if_8 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("name");
			...
			if (dirty & /*infoList*/ 2048) show_if_7 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("path");
			...
			if (dirty & /*infoList*/ 2048) show_if_6 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("extension");
			...
			if (dirty & /*infoList*/ 2048) show_if_5 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("size");
			...
			if (dirty & /*infoList*/ 2048) show_if_4 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("dimension");
			...
			if (dirty & /*infoList*/ 2048) show_if_3 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("date");
			...
			if (dirty & /*infoList*/ 2048) show_if_2 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("tags");
			...
			if (dirty & /*infoList*/ 2048) show_if_1 = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("backlinks");
			...
			if (dirty & /*infoList*/ 2048) show_if = /*infoList*/ ctx[11].length != 0 || !/*infoList*/ ctx[11].contains("palette");
...
function instance$5($$self, $$props, $$invalidate) {
	...
	dimensions.addEventListener(
		"loadedmetadata",
		function (e) {
			$$invalidate(12, width = this.videoWidth);
			$$invalidate(13, height = this.videoHeight);
		},
		false
	);
	...
	$$self.$$set = $$props => {
		...
		if ("dimensions" in $$props) $$invalidate(4, dimensions = $$props.dimensions);
		if ("date" in $$props) $$invalidate(5, date = $$props.date);
		if ("tagList" in $$props) $$invalidate(6, tagList = $$props.tagList);
		if ("colorList" in $$props) $$invalidate(7, colorList = $$props.colorList);
		if ("isVideo" in $$props) $$invalidate(8, isVideo = $$props.isVideo);
		if ("imgLinks" in $$props) $$invalidate(9, imgLinks = $$props.imgLinks);
		if ("frontmatter" in $$props) $$invalidate(10, frontmatter = $$props.frontmatter);
		if ("infoList" in $$props) $$invalidate(11, infoList = $$props.infoList);
	};
...
class GalleryInfo extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-gec6de-style")) add_css$3();
...
class GalleryProcessor {
    async galleryDisplay(source, el, vault, metadata, plugin) {
        let args = {
            type: 'grid',
            path: '',
            name: '',
        ...
        if (!args.path || !args.type) {
            obsidian.MarkdownRenderer.renderMarkdown(GALLERY_DISPLAY_USAGE, elCanvas, '/', plugin);
            return;
        }
    ...
    async galleryImageInfo(source, el, vault, metadata, plugin) {
        let args = {
            imgPath: '',
            ignoreInfo: ''
        };
        ...
        if (!args.imgPath || !imgTFile) {
            obsidian.MarkdownRenderer.renderMarkdown(GALLERY_INFO_USAGE, elCanvas, '/', plugin);
            return;
        }
        ...
        if (imgURL.match(VIDEO_REGEX)) {
            ...
            measureEl = new Image();
            colors = await extractColors_cjs.extractColors(imgURL, EXTRACT_COLORS_OPTIONS);
            isVideo = false;
        }
        ...
        if (imgInfo) {
            imgTags = obsidian.getAllTags(imgInfoCache);
        }
        let imgLinks = [];
        vault.getMarkdownFiles().forEach(mdFile => {
            var _a, _b;
            (_b = (_a = metadata.getFileCache(mdFile)) === null || _a === void 0 ? void 0 : _a.links) === null || _b === void 0 ? void 0 : _b.forEach(link => {
                if (link.link === args.imgPath || link.link === imgName) {
                    imgLinks.push({ path: mdFile.path, name: mdFile.basename });
                }
            });
        });
        if (imgTFile instanceof obsidian.TFile && EXTENSIONS.contains(imgTFile.extension)) {
            new GalleryInfo({
                props: {
        ...
        elCanvas.onClickEvent(async (event) => {
            ...
            if (event.button === 2) {
                ...
                await workspace.getRightLeaf(false).setViewState({ type: OB_GALLERY_INFO });
                workspace.revealLeaf(await workspace.getLeavesOfType(OB_GALLERY_INFO)[0]);
                let infoView = (_a = workspace.getLeavesOfType(OB_GALLERY_INFO)[0]) === null || _a === void 0 ? void 0 : _a.view;
...
class GalleryPlugin extends obsidian.Plugin {
    ...
    async onload() {
        ...
        // Add Gallery Icon
        obsidian.addIcon('fa-Images', galleryIcon);
        obsidian.addIcon('fa-search', gallerySearchIcon);
